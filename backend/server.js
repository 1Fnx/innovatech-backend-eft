...
// No hay valores por defecto sensibles (mejor seguridad)
// =========================================================
...
// Endpoint de salud (no requiere DB, útil para health checks del ALB)
...
// (permite importar app en los tests sin levantar el servidor)
